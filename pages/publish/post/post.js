...
Page({
  ...
  data: {
    ...
    houseArray: ['请选择', '公寓丨Apartment', '小区丨Unit', '别墅丨House', '联排别墅丨Townhouse', '车库丨Garage',  '办公室丨Office', '商铺丨Commercial',  '其它丨Other'],
    houseIndex:0,
    houseVlaue: [0, 1, 4, 2, 3, 7,  5, 6, 8],
    houseType: ['请选择', '主卧', '双人间', '单人间', '床位', '客厅', '整租'],
