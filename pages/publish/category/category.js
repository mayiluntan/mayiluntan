...
Page({
  ...
  data: {
    selectArray:{
      ...
      3: ['房产经济', '金融贷款', '理财保险', '翻译服务', '律师公正', '会计税务', '风水命理', '网站软件', '摄影婚庆', '医疗诊所', '其他'],
      4: ['机场接送', '搬家物流', '汽车维修', '驾校教练', '车行4S店', '租车服务', '运车回国'],
      5: ['宠物服务', '家政保洁', '行李寄存', '开锁配匙', '网络缴费', '花园除草', '除虫清洁', '保姆月嫂', '水暖电工', '数码电子', '二手回收', '防盗报警', '建材装修', '其他'],
      ...
      101:['求租', '招租'],
      102: ['求购信息', '家居家具', '数码电子', '二手教材', '宠物相关', '服装饰品', '游戏娱乐', '美容护肤', '食品饮料', '宝宝用品', '其它综合', '电器相关'],
      103: ['求职', '招聘'],
      104: ['求购', '出售'],
  ...
  secondCate(v) {
    ...
    switch (v) {
      ...
      case 3: selectArray = ['房产经济', '金融贷款', '理财保险', '翻译服务', '律师公正', '会计税务', '风水命理', '网站软件', '摄影婚庆', '医疗诊所', '其他']; break;
      case 4: selectArray = ['机场接送', '搬家物流', '汽车维修', '驾校教练', '车行4S店', '租车服务', '运车回国']; break;
      case 5: selectArray = ['宠物服务', '家政保洁', '行李寄存', '开锁配匙', '网络缴费', '花园除草', '除虫清洁', '保姆月嫂', '水暖电工', '数码电子', '二手回收', '防盗报警', '建材装修', '其他']; break;
      ...
      case 102: selectArray = ['求购信息', '家居家具', '数码电子', '二手教材', '宠物相关', '服装饰品', '游戏娱乐', '美容护肤', '食品饮料', '宝宝用品', '其它综合', '电器相关']; break;
